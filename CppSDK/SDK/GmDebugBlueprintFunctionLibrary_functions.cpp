...
void UGmDebugBlueprintFunctionLibrary_C::InitLevelRangeDebugData(class UObject* __WorldContext)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("GmDebugBlueprintFunctionLibrary_C", "InitLevelRangeDebugData");

	Params::GmDebugBlueprintFunctionLibrary_C_InitLevelRangeDebugData Parms{};
...
// bool&                                   enable                                                 (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor)
// float&                                  r                                                      (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float&                                  g                                                      (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// float&                                  b                                                      (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UObject*                          __WorldContext                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UGmDebugBlueprintFunctionLibrary_C::GetLevelRangeDebugData(int32 type, bool& enable, float& r, float& g, float& b, class UObject* __WorldContext)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("GmDebugBlueprintFunctionLibrary_C", "GetLevelRangeDebugData");

	Params::GmDebugBlueprintFunctionLibrary_C_GetLevelRangeDebugData Parms{};
...
void UGmDebugBlueprintFunctionLibrary_C::SetLevelRangeDebugMode(int32 mode, class UObject* __WorldContext)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("GmDebugBlueprintFunctionLibrary_C", "SetLevelRangeDebugMode");

	Params::GmDebugBlueprintFunctionLibrary_C_SetLevelRangeDebugMode Parms{};
...
void UGmDebugBlueprintFunctionLibrary_C::SetLevelRangeDebugData(int32 type, bool enable, float r, float g, float b, class UObject* __WorldContext)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("GmDebugBlueprintFunctionLibrary_C", "SetLevelRangeDebugData");

	Params::GmDebugBlueprintFunctionLibrary_C_SetLevelRangeDebugData Parms{};
...
int32 UGmDebugBlueprintFunctionLibrary_C::GetLevelRangeDebugMode(class UObject* __WorldContext)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("GmDebugBlueprintFunctionLibrary_C", "GetLevelRangeDebugMode");

	Params::GmDebugBlueprintFunctionLibrary_C_GetLevelRangeDebugMode Parms{};
