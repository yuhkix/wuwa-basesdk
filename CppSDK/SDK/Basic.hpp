...
public:
	constexpr FName(int32 ComparisonIndex = 0, uint32 Number = 0, int32 DisplayIndex = 0)
	...
	constexpr FName(const FName& other)
		: ComparisonIndex(other.ComparisonIndex), Number(other.Number), DisplayIndex(other.DisplayIndex)
	{
	}
